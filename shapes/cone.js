...
Cone.prototype.build = function(Ndiv, baseColor) {
    ...
    vertexArr[3*Ndiv] = 0; /* tip of the cone at (0,0,1) */
    ...
    for (var k = 0; k < Ndiv + 1; k++) {
        color.r = baseColor.r + Math.random() * 0.1;
        color.g = baseColor.g + Math.random() * 0.1;
        color.b = baseColor.b + Math.random() * 0.1;
